    ...
    return (
        <div className='organizations-page'>
            <div className='organizations-page__header'>
                <h1 className='organizations-page__title'>Организации</h1>
                <button
            ...
            {status === 'loading' && (
                <div className='organizations-page__loading'>Загрузка...</div>
            )}
            ...
            {status === 'idle' && organizations.length === 0 && (
                <div className='organizations-page__empty'>
                    ...
                    <button onClick={() => setIsCreateOpen(true)}>Создать первую</button>
                </div>
            )}
                        ...
                        <div className='org-card__info'>
                            ...
                            <div className='org-card__meta'>
                                <span>
                                    ...
                                    {org._count?.members ?? 0} участников
                                </span>
                                <span>
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                                    ...
                                    {org._count?.projects ?? 0} проектов
                                </span>
                            </div>
                            {org.members?.[0]?.role && (
